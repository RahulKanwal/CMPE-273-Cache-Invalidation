...
# Set CACHE_MODE=ttl_invalidate in catalog-service before running
...
echo "Running k6 load test - Scenario C: TTL + Invalidation"
echo "Make sure catalog-service is running with CACHE_MODE=ttl_invalidate"
echo ""
